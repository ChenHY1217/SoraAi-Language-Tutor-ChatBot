...
const IconNav: React.FC = () => {
    ...
    const handleNewChat = () => {
        ...
        // Clear the chat history by navigating to base route
        ...
        <div className="fixed top-6 right-6 z-50">
            <div className="relative">
                <button
                    ...
                    className=" w-12 h-12 rounded-full bg-secondary-400 flex items-center justify-center hover:bg-secondary-500 hover:scale-105 transition-all duration-500"
                >
